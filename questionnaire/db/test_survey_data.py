...
def test_data_creation(connection_params):
	...
	INSERT INTO questions (survey_id,title,answered_quantity,answered_rating,question_text,answer_option_1,answer_option_2,answer_option_3,answer_option_4,created_on,redacted) VALUES
		...
		(1,'Шестой вопрос первого опроса',0,0.00,'К какому вопросу Вы хотели бы перейти?','К десятому','К статистике','','','2024-02-08 09:06:07.066675',NULL),
		(1,'Седьмой вопрос первого опроса',0,0.00,'К какому вопросу Вы хотели бы перейти?','К десятому','К статистике','','','2024-02-08 09:06:29.419019',NULL),
		(1,'Восьмой вопрос первого опроса',0,0.00,'К какому вопросу Вы хотели бы перейти?','К десятому','К статистике','','','2024-02-08 09:07:33.616468',NULL),
		(1,'Девятый вопрос первого опроса',0,0.00,'К какому вопросу Вы хотели бы перейти?','К десятому','К статистике','','','2024-02-08 09:08:03.756847',NULL),
		(1,'Десятый вопрос первого опроса',0,0.00,'Хотели бы посмотреть статистику?','Конечно','Да','','','2024-02-08 09:08:34.139517',NULL);
	''')

	create_questions_query_two = sql.SQL('''
	INSERT INTO questions (survey_id,title,answered_quantity,answered_rating,question_text,answer_option_1,answer_option_2,answer_option_3,answer_option_4,created_on,redacted) VALUES
		(2,'Первый вопрос второго опроса',0,0.00,'Текст первого вопроса второго опроса','Первый ответ первого вопроса','Второй ответ первого вопроса','Третий ответ первого вопроса','Четвертый ответ первого вопроса','2024-02-08 09:09:52.888839',NULL),
		(2,'Второй вопрос второго опроса',0,0.00,'Текст второго вопроса второго опроса','Первый ответ второго вопроса','Второй ответ второго вопроса','Третий ответ второго вопроса','Четвертый ответ второго вопроса','2024-02-08 09:34:19.13053',NULL),
		(2,'Третий вопрос второго опроса',0,0.00,'Текст третьего и последнего вопроса второго опроса','Первый ответ третьего вопроса','Второй ответ третьего вопроса','Третий ответ третьего вопроса','Четвертый ответ третьего вопроса','2024-02-08 09:35:27.02271',NULL),
		(3,'Единственный вопрос третьего опроса',0,0.00,'Сразу к статистике?','Да','Да', '', '','2024-02-08 09:36:10.022097',NULL);
	''')
...
if __name__ == "__main__":
	...
	test_data_creation(connection_params)
